...
import { Heart, Shield, Lock, MessageCircle, Users, Star, ArrowRight, Play, Sparkles, Zap, Compass, Map, Flame, Crown } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-6 py-4">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h1 className="text-2xl font-bold text-white">CoupleCrypt</h1>
